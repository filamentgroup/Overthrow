...
window.onload = function () {
	...
	test('API Properties: overthrow.configure is defined', function () {
		ok(overthrow.configure);
	});

	test('API Properties: overthrow.configure is a function', function () {
		ok(typeof( overthrow.configure ) === "function");
	});
